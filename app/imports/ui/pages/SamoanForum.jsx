...
class SamoanForum extends React.Component {
  ...
  renderPage() {
    return (
        <Container>
          <Header as="h2" textAlign="center" inverted>Samoan Forum</Header>
...
export default withTracker(() => {
  ...
  return {
    posts: Posts.find({ language: 'Samoan' }, { sort: { createdAt: -1 } }).fetch(),
