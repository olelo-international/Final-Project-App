...
class CambodianForum extends React.Component {
  ...
  renderPage() {
    return (
        <Container>
          <Header as="h2" textAlign="center" inverted>Cambodian Forum</Header>
...
export default withTracker(() => {
  ...
  return {
    posts: Posts.find({ language: 'Cambodian' }, { sort: { createdAt: -1 } }).fetch(),
