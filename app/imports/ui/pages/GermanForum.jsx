...
class GermanForum extends React.Component {
  ...
  renderPage() {
    return (
        <Container>
          <Header as="h2" textAlign="center" inverted>German Forum</Header>
...
export default withTracker(() => {
  ...
  return {
    posts: Posts.find({ language: 'German' }, { sort: { createdAt: -1 } }).fetch(),
