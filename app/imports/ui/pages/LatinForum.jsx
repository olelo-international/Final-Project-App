...
class LatinForum extends React.Component {
  ...
  renderPage() {
    return (
        <Container>
          <Header as="h2" textAlign="center" inverted>Latin Forum</Header>
          <Card.Group>
...
export default withTracker(() => {
  ...
  return {
    posts: Posts.find({ language: 'Latin' }).fetch(),
