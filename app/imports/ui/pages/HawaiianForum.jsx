...
class HawaiianForum extends React.Component {
  ...
  renderPage() {
    return (
        <Container>
          <Header as="h2" textAlign="center" inverted>Hawaiian Forum</Header>
...
export default withTracker(() => {
  ...
  return {
    posts: Posts.find({ language: 'Hawaiian' }, { sort: { createdAt: -1 } }).fetch(),
