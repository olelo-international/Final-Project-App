...
class SpanishForum extends React.Component {
  ...
  renderPage() {
    return (
        <Container>
          <Header as="h2" textAlign="center" inverted>Spanish Forum</Header>
...
export default withTracker(() => {
  ...
  return {
    posts: Posts.find({ language: 'Spanish' }, { sort: { createdAt: -1 } }).fetch(),
